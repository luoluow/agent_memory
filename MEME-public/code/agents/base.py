...
# v1 (canonical): Q at bottom. Empirically better on short context-dense systems
# (MD-flat/Mem0/Graphiti) — Sonnet over-refuses with Q-at-top for short contexts.
# Long-context baselines (BM25/Dense) still use this same prompt for consistency.
